...
const preconVisable = useElementVisibility(precon);
const projectVisable = useElementVisibility(project);
const executionVisable = useElementVisibility(execution);
...
const links = computed(() => [
  {
    ...
    to: "#preconstruction",
    active: preconVisable,
  },
  {
    label: "Project Planning",
    to: "#project-planning",
    active: projectVisable,
  },
  {
    label: "Project Execution",
    to: "#project-execution",
    active: executionVisable,
  },
]);
...
<template>
  <div>
    ...
    <header
      class="flex sticky top-0 bg-midnight-950 z-10 sm:justify-start sm:flex-nowrap w-full text-sm py-4 justify-center"
    >
      <nav class="flex gap-3 justify-center w-full">
        <template v-for="link in links">
          <NuxtLink
            :to="link.to"
            class="text-white uppercase font-bold"
            :class="{ 'text-red-600': link.active }"
          >
            {{ link.label }}
          </NuxtLink>
        </template>
