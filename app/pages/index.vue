...
<template>
	...
	<main id="main" class="main">
		<div class="max-w-4xl -mt-24 mx-auto z-40 relative" @click="playPause">
			<video poster="/poster.webp" controlslist="nofullscreen nodownload" class="relative" ref="vid"
				preload="none">
				<source
					...
					<div class="space-y-6 sm:space-y-8">
						<div class="space-y-2 md:space-y-4">
							<h2 class="font-bold uppercase text-4xl lg:text-4xl text-gray-800 dark:text-gray-200 mb-4">
								<span
									class="underline decoration-[var(--focus-yellow)] decoration-4 underline-offset-8">Who</span>
								We Are
							</h2>
							<div class="space-y-4">
								<p>
		...
		<section class="max-w-[85rem] mx-auto pt-14">
			...
			<LazyExpanderMenuCopy hydrate-on-visible />
		</section>
		<section class="max-w-[85rem] px-4 py-14 mx-auto bg-[var(--midnight)]">
			<LazyHowWe hydrate-on-visible />
		</section>
	</main>
</template>
