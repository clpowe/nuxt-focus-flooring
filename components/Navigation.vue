...
<template>
	<header
		class="flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-[var(--midnight)] text-sm py-4 z-50"
	>
		<nav
			...
			>
				...
				>
					...
					<NuxtLink prefetch to="/portfolio" class="text-white"
						>Portfolio</NuxtLink
					>
					<NuxtLink prefetch to="/contact/general-contact" class="text-white"
						>Contact
					</NuxtLink>
					<button
